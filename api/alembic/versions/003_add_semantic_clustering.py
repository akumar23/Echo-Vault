"""Add semantic clustering tables
...
def upgrade() -> None:
    # Create semantic_clusters table
    op.create_table(
        'semantic_clusters',
    ...
    # Create entry_cluster_memberships table
    op.create_table(
    ...
    # Create cluster_transitions table
    op.create_table(
        'cluster_transitions',
        sa.Column('id', sa.Integer(), nullable=False),
        sa.Column('user_id', sa.Integer(), nullable=False),
    ...
    # Add clustering metadata columns to entry_embeddings table
...
def downgrade() -> None:
    # Remove columns from entry_embeddings
