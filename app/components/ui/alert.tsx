  ...
  'relative w-full rounded-md border px-4 py-3 text-sm [&>svg+div]:translate-y-[-3px] [&>svg]:absolute [&>svg]:left-4 [&>svg]:top-4 [&>svg]:text-foreground [&>svg~*]:pl-7',
  {
    variants: {
      variant: {
        ...
        warning:
          'border-[color:var(--warning)]/40 bg-[color:var(--warning)]/10 text-[color:var(--warning)] [&>svg]:text-[color:var(--warning)]',
        success:
          'border-[color:var(--success)]/40 bg-[color:var(--success)]/10 text-[color:var(--success)] [&>svg]:text-[color:var(--success)]',
      },
    },
    defaultVariants: {
      variant: 'default',
